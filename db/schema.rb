...
ActiveRecord::Schema.define(version: 20170227130926) do
  ...
  create_table "group_members", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",    null: false
    t.datetime "updated_at",    null: false
    t.index ["chat_group_id"], name: "index_group_members_on_chat_group_id", using: :btree
  ...
  add_foreign_key "group_members", "chat_groups"
